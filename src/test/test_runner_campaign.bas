'============================================================================
' Campaign Tests Runner
'============================================================================
' Test campaign.bas functionality

DECLARE SUB RunCampaignTestSuite ()
CALL RunCampaignTestSuite
END
...
SUB RunCampaignTestSuite
    CALL InitializeTestVariables
    
    PRINT STRING$(80, "=")
    PRINT "CAMPAIGN TESTS"
    PRINT STRING$(80, "=")
    PRINT
